...
- `style.css` — responsive modern sidebar, canvas, validation, length-results, and inspector styling.
- `app.js` — client-side computational geometry, SVG rendering, terminal dragging, shared terminal pads, auto-fit, validation, and exports.
